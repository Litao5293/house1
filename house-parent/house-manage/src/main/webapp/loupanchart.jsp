			...
			<div id="main">
				<div id="box_border">
					<ul id="fang_type">
						...
						<li style="background-color: #b51d1a;">已租赁</li>
						<li style="background-color: #000EFF;">已配租</li>
						<li style="background-color: #a5c438;">欠费</li>
						<li style="background-color: #7065D5;">腾退待租</li>
						<li style="background-color: #917430;">建成待租</li>
						<li style="background-color: #23b628;">在建</li>
						<li style="background-color: #7b8587;">其他</li>
					</ul>
				</div>
